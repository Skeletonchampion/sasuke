        ...
        <nav className="relative mb-6 bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
            <div className="flex mx-12 items-center justify-center mb-6">
                ...
                <div id="info" className="flex">
                    ...
                    <a href="#" role="button" className="relative flex mx-2">
            ...
            <ul id="categories" className="flex justify-between mx-14">
                ...
                onClick={() => {
                    if(dropDownRef.current) {
                        if(dropDownRef.current.classList.contains("visible")) dropDownRef.current.className = "opacity-0 h-0 px-4 z-20 duration-300 absolute top-30 left-0 w-full";
                        else dropDownRef.current.className = "visible opacity-100 px-4 z-20 duration-300 absolute top-30 left-0 w-full";
                    }
                }} >
