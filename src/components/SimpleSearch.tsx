...
export function SimpleSearch() {
    ...
    const handleSimpleSearch = () => {
        const query = `author=${author}&title=${title}&keyword=${keyword}`;
                ...
                <div className="simple-search">
                    <div id="author" className="my-4">
                        ...
                        <div className="relative w-full">
                            ...
                            <input disabled onChange={(e) => setAuthor(e.target.value)} type="text" id="author-input" className="w-full border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block pl-8 pr-2.5 py-3  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter author" required />
                        </div>
                    </div>
                    <div id="title" className="my-4">
                        ...
                        <div className="relative w-full">
                            ...
                            <input onChange={(e) => setTitle(e.target.value)} type="text" id="title-input" className="w-full border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block pl-8 pr-2.5 py-3  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter title" required />
                        </div>
                    </div>
                    <div id="keyword" className="my-4">
                        ...
                        <div className="relative w-full">
                            ...
                            <input disabled onChange={(e) => setKeyword(e.target.value)} type="text" id="keyword-input" className="w-full border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block pl-8 pr-2.5 py-3  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter keyword" required />
                        </div>
                    </div>
                </div>
                <button onClick={handleSimpleSearch} className="rounded-2xl w-full text-white mt-8 px-6 py-2 bg-cyan-600 hover:bg-blue-600 duration-300">Search</button>
            </div>
