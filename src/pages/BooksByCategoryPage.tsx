...
export function BooksByCategoryPage() {
    ...
    const { URL, GET_BOOKS_BY_CATEGORY } = useGlobal();

    const { category } = useParams<string>();
    const newCategory = convertString(category!);
    ...
    React.useEffect(() => {
        (async () => {
            const res = await axios.get(`${URL}/${GET_BOOKS_BY_CATEGORY}/${newCategory}`);
        ...
        <>
            ...
            <div className="flex ml-40">
                <div className="flex">
                    ...
                    <div className="">
                        <h2 className="text-3xl font-bold ml-16 mb-8">{bookState[0]?.category}</h2>
